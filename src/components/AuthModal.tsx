    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto border border-gray-100">
        ...
        <div className="relative px-8 pt-8 pb-6">
          <button
            onClick={onClose}
            className="absolute top-6 right-6 p-2 hover:bg-gray-100 rounded-full transition-all duration-200"
          >
          ...
          <div className="text-center">
            ...
            <h2 className="text-3xl font-extrabold mb-2 bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 bg-clip-text text-transparent">
        ...
        <div className="px-8 pb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {mode === 'signup' && (
              <div>
                ...
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 transition-colors group-focus-within:text-gray-600" />
                  <input
                    type="text"
                    required
                  ...
                  <div className="p-4 border-2 border-gray-200 rounded-xl bg-gradient-to-br from-gray-50 to-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Manage your restaurant and reach customers</div>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="p-4 border-2 border-gray-200 rounded-xl bg-gradient-to-br from-gray-50 to-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Browse restaurants and order delicious meals</div>
                      </div>
                    </div>
                  </div>
                )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-gray-900 text-white rounded-xl font-bold hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-6"
            >
              {loading ? (
                <>
          ...
          <div className="mt-8 text-center">
            ...
            <button
              ...
              className="mt-4 text-gray-900 font-semibold hover:underline transition-all"
            >
